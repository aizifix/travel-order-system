...
function useDrawer(rows: readonly AdminTravelOrderItem[], initialOrderId?: number) {
  const [selectedOrder, setSelectedOrder] = useState<AdminTravelOrderItem | null>(() => {
          ...
          {readyForFinalReview ? (
            <div className="mt-2 grid gap-2 sm:grid-cols-3">
              ...
              <button
                type="submit"
                form={returnFormId}
                className="inline-flex h-10 w-full items-center justify-center rounded-lg bg-[#d8a347] px-4 text-sm font-semibold text-white transition hover:bg-[#be8f3d]"
              >
                Return
              </button>
