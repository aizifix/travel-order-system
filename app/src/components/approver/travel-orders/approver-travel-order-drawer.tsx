...
function buildTimelineTrips(order: ApproverTravelOrderItem): readonly TimelineTripItem[] {
...
export function ApproverTravelOrderDrawer({
  order,
  onReview,
  onClose,
}: Readonly<{
          ...
          {isPending ? (
            <div className="mt-2 grid gap-2 sm:grid-cols-2">
              <button
                type="submit"
                form={confirmFormId}
                className="inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-[#3B9F41] px-4 text-sm font-semibold text-white transition hover:bg-[#359436]"
              >
              ...
              <button
                type="submit"
                form={rejectFormId}
                className="inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-[#E35E5E] px-4 text-sm font-semibold text-white transition hover:bg-[#ca4e4e]"
              >
                <X className="h-4 w-4" />
                Reject Request
              </button>
